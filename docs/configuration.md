...
| `SENTRY_DSN` | — | Backend Sentry DSN. When set, the server reports recovered panics and every 4xx/5xx response (with the underlying cause) to Sentry. Empty disables backend reporting. |
